            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="Bank_name" class="col-md-4 col-form-label text-md-right">{{ __('User Bank Name') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="acct_name" class="col-md-4 col-form-label text-md-right">{{ __('User Account Name') }}</label>

                            <div class="col-md-6">
                                <input id="acct_name" type="text" class="form-control @error('acct_name') is-invalid @enderror" name="acct_name" value="{{ old('acct_name') }}" required autocomplete="acct_name" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="acct_no" class="col-md-4 col-form-label text-md-right">{{ __('Account Number') }}</label>

                            <div class="col-md-6">
                                <input id="acct_no" type="number" class="form-control @error('acct_no') is-invalid @enderror" name="acct_no" value="{{ old('acct_no') }}" required autocomplete="acct_no" autofocus>
